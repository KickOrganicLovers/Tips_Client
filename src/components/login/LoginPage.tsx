...
import {setErrorMessage, setIsLoggedIn, setUserStatus} from "../../redux/LoginStatusSlice";
...
const LoginPage: React.FC = () => {
    ...
    const submitEventHandler = () => {
        login().then((val) => {
            ...
            dispatch(setErrorMessage(val.errorMessage))
            dispatch(setUserStatus(val.userStatus))
        })
    }
