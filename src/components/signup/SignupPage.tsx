...
import {LoginItemScheme, SignupPageState, UserScheme} from "../../types";
...
const SignupPage: React.FC = () => {
    ...
    const checkIfItAlreadyExists = async (req: LoginItemScheme) => {
        const url = 'http://localhost:5005/signup'
        const params = {
            method: 'POST',
